...
### Expo Icons
We chose to use the expo-icons since this library was already installed through expo inti. All icons from this library are available at `@expo/vector-icons` directory. Here, we found the emoji icons we needed for our application.
...
### Styled Components
For styling our components we used the `styled` component from the `styled-components` library which provides an easy-to-use, CSS-like way of styling your react components.
